...
export const createInitialFormData = (config) => {
  const baseData = {
    ...
    prasarana: {
      ...
      ruangPerpustakaan: { jumlah: '', baik: '', rusakSedang: '', rusakBerat: '' },
      ruangLaboratorium: { jumlah: '', baik: '', rusakSedang: '', rusakBerat: '' },
      ruangGuru: { jumlah: '', baik: '', rusakSedang: '', rusakBerat: '' },
      ruangUks: { jumlah: '', baik: '', rusakSedang: '', rusakBerat: '' },
      toiletGuruSiswa: { jumlah: '', baik: '', rusakSedang: '', rusakBerat: '' },
