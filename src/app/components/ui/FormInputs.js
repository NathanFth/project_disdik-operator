...
export const NumberInput = ({ label, value, onChange, error, placeholder = '0', required }) => (
...
export const TextInput = ({ label, value, onChange, error, placeholder, required }) => (
  <div className="w-full">
    <label className="block text-sm font-medium text-foreground mb-1.5">
      {label} {required && <span className="text-destructive">*</span>}
    </label>
...
export const SelectInput = ({ label, value, onChange, options, error, placeholder, required }) => (
  <div className="w-full">
    <label className="block text-sm font-medium text-foreground mb-1.5">
      {label} {required && <span className="text-destructive">*</span>}
    </label>
